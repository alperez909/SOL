		...
		<div class="navbar" style="margin-top:1.5%">
			<div class="navbar-inner">
				<div class="container">
					...
					<a class="brand" href="/" style="padding:5px 20px;"> <%=""/*site.get("Site_name").get(0)*/%>
					...
					<div class="nav-collapse">
						<ul class="nav">
							...
							<li>
								<form method="get" action="/product/search.jsp" id="search" style="margin:0 5px">
									<input name="q" size="40" type="text" style="margin-top:5px; margin-bottom:0">
								</form>
							</li>
							<!--
