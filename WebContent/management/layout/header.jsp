...
<%
	...
	//System.out.println(manager + "  =============>BETO");
			...
			<div class="navbar-inner">
				<div class="container" style="position:relative" >
					<%
						if (site != null) {
					%>
					<a class="brand" href="/" style="padding: 0 20px;  position: absolute; top: 50%; transform: translateY(-50%);">
						<img
						alt="Logo" src="<%=site.get("Logo_image").get(0)%>" style =" max-height: 25px; width: auto;"/>
